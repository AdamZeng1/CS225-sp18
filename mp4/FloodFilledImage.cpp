...
void FloodFilledImage::addFloodFill(ImageTraversal & traversal, ColorPicker & colorPicker) {
	/** @todo [Part 2] */
	//traversal_ = &traversal;   // important to pass by reference
	//color_ = &colorPicker; 
	traversal_.push_back(&traversal);   // important to pass by reference
...
Animation FloodFilledImage::animate(unsigned frameInterval) {
	...
	list<ImageTraversal*>::iterator it_traverse;
	list<ColorPicker*>::iterator it_color = color_.begin();
